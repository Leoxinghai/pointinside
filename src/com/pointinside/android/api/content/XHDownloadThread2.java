 ...
 */
public class XHDownloadThread2 extends Thread {
    ...
    public XHDownloadThread2(Context paramContext, DownloadInfo paramDownloadInfo)
    {
...
http_request_loop:
            while (true) {
                ...
                if (XHConstants2.LOGV) {
                    Log.v(XHConstants2.TAG, "initiating download for " + mInfo.mUri);
                }
                ...
                if (statusCode == 503 && mInfo.mNumFailed < XHConstants2.MAX_RETRIES) {
